    ...
    describe('OU', function() {
      it('destroys an ou', function() {
        return store.ready(function() {
          ...
          return Ou.find(
            'ou=destroy_me_ou,ou=destroy_test,ou=openrecord,' + LDAP_BASE
          ).exec(function(ou) {
      ...
      it('returns an error on ou destroys with children', function() {
        return store
          .ready(function() {
            var Ou = store.Model('OrganizationalUnit')
            return Ou.find(
              'ou=destroy_me_sub_ou,ou=destroy_test,ou=openrecord,' + LDAP_BASE
            ).exec(function(ou) {
              return ou.destroy()
            })
          })
        ...
        return store.ready(function() {
          ...
          return Ou.find(
            ...
            return ou.destroyAll(function() {
              return Ou.find('ou=destroy_test,ou=openrecord,' + LDAP_BASE)
                .include('ous')
                .exec(function(ou) {
    ...
    describe('Group', function() {
      it('destroys a group', function() {
        return store.ready(function() {
          ...
          return Group.find(
            'cn=destroy_me_group,ou=destroy_test,ou=openrecord,' + LDAP_BASE
          ).exec(function(group) {
      ...
      it('destroys a computer', function() {
        return store.ready(function() {
          ...
          return Computer.find(
            'cn=destroy_me_computer,ou=destroy_test,ou=openrecord,' + LDAP_BASE
          ).exec(function(computer) {
            return computer.destroy(function() {
              return Computer.find(
                'cn=destroy_me_computer,ou=destroy_test,ou=openrecord,' +
                  LDAP_BASE
              ).exec(function(computer) {
    ...
    describe('User', function() {
      it('destroys a user', function() {
        return store.ready(function() {
          ...
          return User.find(
            'cn=destroy_me_user,ou=destroy_test,ou=openrecord,' + LDAP_BASE
          ).exec(function(user) {
