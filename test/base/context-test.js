...
describe('Context', function() {
  ...
  describe('setContext()', function() {
    ...
    it('passes the context to nested relational objects', function() {
            ...
            comments: [
              {
                ...
                super_nesteds: [{ words: 'nested words' }]
              }
            ]
          }
        ]
      ...
      user.posts[0].comments[0].super_nesteds[0].context.should.be.eql(
        myContext
      )
    })
    ...
    it('passes the context to newly built nested relational objects', function() {
      ...
      var newlyNested = user._posts[0]._comments[0].super_nesteds.new({
        words: 'nested words'
      })
