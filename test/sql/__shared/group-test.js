  ...
  describe(title + ': Group', function() {
    ...
    it('group two field without select', function() {
      return store.ready(function() {
        ...
        return Post.group('thread_id', 'message')
    ...
    it('group with raw having', function() {
      return store.ready(function() {
        ...
        return Post.group('message')
          ...
          .order('message')
          .exec(function(posts) {
            posts.should.be.eql([{ message: 'first', count: 2 }])
          })
      })
    })
    ...
    it('group with hash having', function() {
      return store.ready(function() {
        ...
        return Post.group('message', 'thread_id')
          .select('message', 'COUNT(*) count')
          .having({ thread_id_gt: 1 })
          .order('message')
          .exec(function(posts) {
            posts.should.be.eql([
