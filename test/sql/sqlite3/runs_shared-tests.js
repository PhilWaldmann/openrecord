...
testSQLite('plugins/stampable', [
  'CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT, login TEXT, email TEXT, created_at TEXT, updated_at TEXT)',
  'CREATE TABLE posts(id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, thread_id INTEGER, message TEXT, created_at TEXT, updated_at TEXT, creator_id integer, updater_id integer)',
