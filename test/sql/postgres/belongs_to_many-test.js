...
describe('Postgres: belongsToMany()', function() {
  ...
  it('does have a proper relation definition', function() {
    return store.ready(function() {
      ...
      User.definition.relations.folders.model.definition.modelName.should.be.equal(
        'Folder'
      )
    })
  })
  ...
  it('does have a proper reverse relation definition', function() {
    return store.ready(function() {
      ...
      Folder.definition.relations.users.model.definition.modelName.should.be.equal(
        'User'
      )
    })
  })
