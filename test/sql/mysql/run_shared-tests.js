...
testMYSQL('attribute_format', [
  'CREATE TABLE users(id serial primary key, user_login TEXT, secret_email_address TEXT)',
  'CREATE TABLE posts(id serial primary key, user_id INTEGER, thread_id INTEGER, message TEXT)',
  'CREATE TABLE threads(id serial primary key, user_id INTEGER, title TEXT)',
...
testMYSQL('dependent_delete', [
  ...
  "INSERT INTO posts(user_id, thread_id, message) VALUES(1, 1, 'first message'), (1, 1, 'second'), (1, 2, 'third'), (2, 3, 'michls post'), (3, 3, 'for poly!')",
  "INSERT INTO threads(user_id, title) VALUES(2, 'first thread'), (1, 'second thread'), (1, '3. thread'), (1, '4. thread')",
  "INSERT INTO poly_things (member_id, member_type, user_id) VALUES (4, 'Post', 1), (3, 'Thread', 1), (4, 'Thread', 2), (5, 'Post', 3)"
])
...
testMYSQL('temporary_definition', [
  'CREATE TABLE users(id serial primary key, login TEXT, email TEXT, created_at TEXT)',
  'CREATE TABLE posts(id serial primary key, user_id INTEGER, thread_id INTEGER, message TEXT)',
  'CREATE TABLE threads(id serial primary key, user_id INTEGER, title TEXT)',
...
testMYSQL('order', [
  ...
  'CREATE TABLE posts(id serial primary key, user_id INTEGER, thread_id INTEGER, message TEXT)',
  'CREATE TABLE threads(id serial primary key, user_id INTEGER, title TEXT)',
  "INSERT INTO users(login, email, created_at) VALUES('phil', 'phil@mail.com', '2014-01-01'), ('michl', 'michl@mail.com', '2014-01-10'), ('admin', 'admin@mail.com', '2014-01-01'), ('administrator', 'administrator@mail.com', '2014-01-01')",
  "INSERT INTO posts(user_id, thread_id, message) VALUES(1, 1, 'first message'), (1, 1, 'second'), (1, 2, 'third'), (2, 1, 'michls post')",
  "INSERT INTO threads(user_id, title) VALUES(2, 'first thread'), (1, 'second thread')"
])
