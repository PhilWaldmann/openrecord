...
global.beforeGraphQL = function(database, done){
  ...
  var sql1 = [
    ...
    'CREATE TABLE recipes(id serial primary key, title TEXT, description TEXT, author_id INTEGER)',
    ...
    "INSERT INTO recipes(title, description, author_id) VALUES('Toast Hawaii', 'take a toast, some pinapple and toast it', 1), ('scrambled eggs', 'scramble your eggs until done', 1), ('Steak', 'First of all: you need good quality beef.', 1), ('Spinach Enchiladas', 'If you like spinach and Mexican food, you will love these easy vegetarian enchiladas made with ricotta cheese and spinach.', 2)",
