          ...
          if(relation.dependent === 'destroy' || relation.dependent === 'delete'){
            tmp.push(function(){
              if(relation.type === 'has_many'){
                ...
                return relation.model.where(conditions).useTransaction(options.transaction).limit(1).exec(function(subrecord){
                  if(subrecord){
