exports.chain = {
  convertConditionAttribute: function(attribute, parentRelations){
    parentRelations = parentRelations || this.getInternal('parent_relations') || [this.definition.tableName]
    return this.definition.store.utils.toAttributeName(attribute, parentRelations)
  },
