...
exports.store = {
  ...
  runMigrations: function(){
    if(!this.connection || this.migrations.length === 0 || this.migrations_finished){
  ...
  loadMigrationHistory: function(){
    ...
    return this.connection.schema.hasTable(this.migration_table)
    .then(function(exists){
      if(!exists) {
        return self.connection.schema.createTable(self.migration_table, function(table){
          table.string('name')
        })
      }
    })
