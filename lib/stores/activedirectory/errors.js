exports.store = {
  ...
  mixinCallback: function(){
    ...
    //TODO: read all articles!
    this.addLdapValidationError('OtherError', '00002089', 'parent_dn', 'not valid');
    this.addLdapValidationError('OtherError', '00000523', 'sAMAccountName', 'invalid characters');
    ...
    this.addLdapValidationError('NotAllowedOnNonLeafError', '0000208C', 'base', 'contains children');
    this.addLdapValidationError('EntryAlreadyExistsError', 'ENTRY_EXISTS', 'sAMAccountName', 'already exists');
    //https://technet.microsoft.com/en-us/library/dn535779.aspx
    this.addLdapValidationError('ConstraintViolationError', '000021C8', 'userPrincipalName', 'already exists');


    this.addLdapValidationError('NoSuchObjectError', '00000525', 'member', 'unknown member added');
    this.addLdapValidationError('UnwillingToPerformError', '00000561', 'member', 'unknown member removed');

    //http://ldapwiki.willeke.com/wiki/Common%20Active%20Directory%20Bind%20Errors
    this.addLdapValidationError('InvalidCredentialsError', 'data 525', 'base', 'user not found');
    this.addLdapValidationError('InvalidCredentialsError', 'data 52e', 'base', 'invalid credentials');
    this.addLdapValidationError('InvalidCredentialsError', 'data 52f', 'base', 'not permitted due to account restrictions');
    this.addLdapValidationError('InvalidCredentialsError', 'data 530', 'base', 'not permitted to logon at this time');
    this.addLdapValidationError('InvalidCredentialsError', 'data 531', 'base', 'not permitted to logon at this workstation');
    this.addLdapValidationError('InvalidCredentialsError', 'data 532', 'base', 'password expired');
    this.addLdapValidationError('InvalidCredentialsError', 'data 533', 'base', 'account disabled');
    this.addLdapValidationError('InvalidCredentialsError', 'data 586', 'base', 'too many context ids');
    this.addLdapValidationError('InvalidCredentialsError', 'data 701', 'base', 'account expired');
    this.addLdapValidationError('InvalidCredentialsError', 'data 773', 'base', 'user must reset password');
    this.addLdapValidationError('InvalidCredentialsError', 'data 775', 'base', 'user account locked');
