...
exports.store = {
  mixinCallback: function(){
    ...
    this.Model('User', function(){
      ...
      this.belongsTo('ou', {ldap: 'parent', autoSave: true})
      this.hasMany('groups', {primary_key: 'dn', foreign_key: 'member', contains: true, autoSave: true})
      ...
      this.convertWrite('unicodePwd', function(password){
        ...
        for(var i = 0; i < password.length; i++){
          convertedPassword += String.fromCharCode(password.charCodeAt(i) & 0xFF, (password.charCodeAt(i) >>> 8) & 0xFF)
        }
