...
exports.store = {
  mixinCallback: function(){
    this.Model('OrganizationalUnit', function(){
      ...
      this.hasChildren('ous', {model: 'OrganizationalUnit', conditions: {objectClass: 'organizationalUnit'}})
      this.hasChildren('users', {model: 'User', conditions: {objectClass: 'user'}})
      this.hasChildren('groups', {model: 'Group', conditions: {objectClass: 'group'}})
      this.hasChildren('computers', {model: 'Computer', conditions: {objectClass: 'group'}})
    })
  }
}
