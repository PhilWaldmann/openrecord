...
exports.store = {
  ...
  mixinCallback: function(){
    ...
    this.addOperator('lt', function(attr, value, options){
      options.filter.filters.push(new ldap.LessThanFilter({ attribute: attr, value: value.toString() }));
    },{
      on:{
        'all': false,
        'number': true,
    ...
    this.addOperator('lte', function(attr, value, options){
      options.filter.filters.push(new ldap.LessThanEqualsFilter({ attribute: attr, value: value.toString() }));
    },{
      on:{
        'all': false,
        'number': true,
