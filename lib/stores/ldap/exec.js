  ...
  mixinCallback: function(){
    ...
    this.onFind(function(options, data){
      ...
      return new Promise(function(resolve, reject){
        chain.connection.search(options.root, options, options.controls, function(err, res){
          debug('Search ' + options.root + ' (Scope=' + options.scope + ', Filter=' + options.filter.toString() + ', Attributes=' + options.attributes)
          ...
          res.on('error', function(err) {
            if(err instanceof ldap.NoSuchObjectError){
              return resolve() // TODO: Custom error + catch => convert result to null
            }
            reject(err)
          })
        })
...
exports.model = {
  ...
  checkRangeAttributes: function(entry, target, callback){
    ...
    this.connection.search(obj.dn, {attributes: ranges}, [], function(error, res){
