...
exports.definition = {
  ...
  createCompositeType(name, attributes, attr){
    ...
    var definition = new Definition(this.store, name)
    ...
    definition.include([
      ...
      path.join(__dirname, '..', '..', 'stores', 'postgres', 'attributes.js'),
      path.join(__dirname, '..', '..', 'stores', 'postgres', 'data_types', '*')
    ])
