...
exports.definition = {
      ...
      attributes.map(function(attr){
        ...
        if(attr.type === 'composite'){
          ...
          self.validates(function(){
            ...
            if(parent[attr.name] && typeof parent[attr.name].isValid === 'function'){
          ...
          return self.createCompositeType(attr.type_name, attr.type_attributes, attr)
        }
      })
    )
  },
  ...
  createCompositeType: function(name, attributes, attr){
    ...
    if(store.dynamic_attribute_types[name]){
      // TODO: is currently shared between all attributes with the same type
