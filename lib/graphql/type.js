    ...
    this.graphQLObjectType = new graphql.GraphQLObjectType({
      ...
      fields: function(){
        ...
        Object.keys(self.attributes).forEach(function(key){
          ...
          // dynamic type (e.g. postgres composite type)
          if(attribute.dynamicType && attribute.dynamicType.definition){
            field.type = self.getGraphQLObjectType.call(attribute.dynamicType.definition)
          }
          ...
          if(attribute.variant){
            ...
            .forEach(function(key){
              ...
              if(!type) throw new Store.UnknownAttributeTypeError(attribute.variant.args[key])
        ...
        if(self.record_methods){
          ...
          Object.keys(self.record_methods).forEach(function(key){
            ...
            if(options && options.return_type){
              ...
              if(options.args){
                field.args = self.store.utils.sanitizeArgs(self, options.args)
              }
          ...
          Object.keys(self.relations).forEach(function(key){
            ...
            if(relation.scope){
              ...
              if(fn && fn.options){
                ...
                if(fn.options.args){
                  field.args = self.store.utils.sanitizeArgs(self, fn.options.args)
                }
              }
            }
