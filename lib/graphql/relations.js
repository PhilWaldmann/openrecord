...
exports.definition = {
  relation: function(name, options) {
    if(options.graphql){
      ...
      if(typeof options.graphql !== 'object') throw new Error('graphql option must be an object')
      ...
      options.getter = function() {
        ...
        Object.keys(options.graphql).forEach(function(key){
          if(typeof options.graphql[key] !== 'function') throw new Error('graphql.' + key + ' must be a function')
