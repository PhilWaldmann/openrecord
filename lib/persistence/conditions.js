...
exports.model = {
  ...
  _applyCondtions: function(conditions, findObj){
    var self = this
    var calls = []
    ...
    conditions.forEach(function(condition){
      ...
      calls.push(function(){
        ...
        return self.callInterceptors(interceptor, [self, condition, findObj])
      })
    })
...
exports.definition = {
  mixinCallback: function(){
    this.beforeFind(function(findObj){
      var conditions = this.getInternal('conditions') || []
      return this._applyCondtions(conditions, findObj)
    }, -70)
    ...
    this.onHashCondition(function(chain, condition, query){
      ...
      if(valueType === 'object' && value.attribute){
        valueType = 'attribute'
        if(value.model.definition.attributes[value.attribute].type.array){
      ...
      if(operator.on){
        if(operator.on[valueType] || (operator.on[valueType] !== false && operator.on.all !== false)){
          ...
          throw new Error("Operator '" + operator.name + "' of attribute '" + condition.attribute + "' can't process value of type '" + valueType + "'")
        }
      }
