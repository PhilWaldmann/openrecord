...
exports.store = {
  ...
  addOperator: function(name, fn, options){
    ...
    /* istanbul ignore next */
    if(this.operatorTypes[name]) throw new Error("Operator '" + name + "' already exists")
  ...
  appendOperator: function(type, operator){
    /* istanbul ignore next */
    if(!this.attributeTypes[type]) throw new Error("Can't find type '" + type + "'")
    /* istanbul ignore next */
    if(!this.operatorTypes[operator]) throw new Error("Can't find operator '" + operator + "'")
