...
var pseudoLogger = {
  trace: process.env.TRACE === 'openrecord' ? console.trace : function(){},
  info: process.env.DEBUG === 'openrecord' ? console.info : function(){},
  warn: console.warn,
  error: console.error
}
...
Store.prototype.ready = function(next){
  ...
  this.modelsInitializer = this.utils.parallelWithPriority(this.middleware)
  .then(function(){
