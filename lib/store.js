...
Store.registeredTypes = {
  'base': require('./base'),
  'sql': require('./base').concat(require('./persistence'), require('./stores/sql')),
  'postgres': require('./base').concat(require('./persistence'), require('./stores/sql'), require('./stores/postgres')),
  'sqlite3': require('./base').concat(require('./persistence'), require('./stores/sql'), require('./stores/sqlite3')),
  'mysql': require('./base').concat(require('./persistence'), require('./stores/sql'), require('./stores/mysql')),
  'oracle': require('./base').concat(require('./persistence'), require('./stores/sql'), require('./stores/oracle')),
  'rest': require('./base').concat(require('./persistence'), require('./stores/rest')),
  'ldap': require('./base').concat(require('./persistence'), require('./stores/ldap')),
  'activedirectory': require('./base').concat(require('./persistence'), require('./stores/ldap'), require('./stores/activedirectory'))
}
