  ...
  hasMany: function(name, options){          
    ...
    options.setter = function(records){
      if(!this.relations[name]){
        ...
        this.model.definition.emit(this, 'relation_initialized', options, this.relations[name]);
      }
  ...
  belongsTo: function(name, options){    
    ...
    options.setter = function(record){
      ...
      if(this.relations[name] && added){
        this.model.definition.emit(this, 'relation_record_added', options, this.relations[name]);
      }
    };
