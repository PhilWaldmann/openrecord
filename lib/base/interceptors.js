...
exports.model = {
  callInterceptors: function(name, scope, args, callback){ //TODO: do we need the scope here?
    ...
    if(!this.definition.interceptors[name]) return this.reject(new UnknownInterceptorError(name));
    if(typeof callback != 'function') return this.reject(new NoCallbackError());
