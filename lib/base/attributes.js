...
exports.record = {
      ...
      if(this.definition.attributes.hasOwnProperty(field)){
        ...
        if(this.attributes[field] !== value){            
          ...
          if(definition.writable && !(value === null && this.attributes[field] === undefined)){
            var before_value = this.attributes[field]
          ...
          if(definition.track_object_changes && this.attributes[field] === undefined){
            //initial object hash
            this.object_changes[field] = this.objectHash(value);
          }
          
          var old_value = this.attributes[field];
          
          this.attributes[field] = value;          
          
          if(definition.emit_events){
            //emit old_value, new_value
            this.definition.emit(field + '_changed', this, old_value,  value);  
          }
  ...
  get: function(name){
    ...
    if(attr){
      ...
      return this.definition.attributes[name].type.cast.output.call(this, this.attributes[name]);
    }
    ...
    for(var field in this.object_changes){
      if(this.object_changes.hasOwnProperty(field)){
        if(this.attributes[field]){
          ...
          if(hash != this.object_changes[field] && !this.changes[field]){
            this.changes[field] = [this.attributes[field], this.attributes[field]];
          }
        }
      }
    }
