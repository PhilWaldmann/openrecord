...
exports.definition = {
  hasMany: function(name, options){
    ...
    options.clear = options.clear || function(parent, collection){
      ...
      var conditions = utils.recordsToConditions(records, targetPrimaryKeys, targetPrimaryKeys)
      
      if(!conditions && collection._isResolved()) return 
      if(!conditions) conditions = utils.recordsToConditions([parent], options.from, options.to)
