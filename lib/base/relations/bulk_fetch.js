exports.definition = {
  ...
  _bulkFetch: function(name, options){
    ...
    options.loadFromRecords = options.loadFromRecords || function(parentCollection, include){
      include = include || {}
    ...
    // TODO: put into utils!?
    function defaultFetch(parentCollection, conditions, include){
    ...
    options.getFromCache = function(parentRecord, include){
      const parentCollection = parentRecord.__chainedModel || parentRecord.model.chain().add(parentRecord)
      
      return options.loadFromRecords(parentCollection, include || {})
      .then(function(result){        
