exports.definition = {
  ...
  _bulkFetch: function(name, options){
    ...
    options.loadFromRecords = options.loadFromRecords || function(parentCollection, include, existingCollection){
      include = include || {}
      ...
      return defaultFetch(parentCollection, conditions, include, existingCollection)
    ...
    // TODO: put into utils!?
    function defaultFetch(parentCollection, conditions, include, existingCollection){
    ...
    options.getFromCache = function(parentRecord, include, existingCollection){
      ...
      return options.loadFromRecords(parentCollection, include || {}, existingCollection)
      .then(function(result){
