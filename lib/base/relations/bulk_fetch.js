exports.definition = {
  ...
  _bulkFetch: function(name, options){
    ...
    options.loadFromConditions = options.loadFromConditions || function(parentCollection, parentConditions, include){          
      include = include || {}
      const conditions = utils.parentConditionsToConditions(parentConditions || [], options.from, options.to)
    ...
    options.loadFromRecords = options.loadFromRecords || function(parentCollection, include, existingCollection){
      ...
      const conditions = utils.recordsToConditions(parentCollection, options.from, options.to)      
    ...
    function defaultFetch(parentCollection, conditions, include, existingCollection){
      ...
      if(existingCollection){
        ...
        utils.assignInternals(query, existingCollection, {exclude: ['relation', 'relation_to']})
      }
